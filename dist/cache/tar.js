...
import { CompressionMethod, SystemTarPathOnWindows, ArchiveToolType, TarFilename, } from './constants';
...
// Create a tar
export async function createTar(archiveFolder, sourceDirectories) {
